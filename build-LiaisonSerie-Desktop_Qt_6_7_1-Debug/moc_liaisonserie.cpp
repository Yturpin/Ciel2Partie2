...
#include "../LiaisonSerie/liaisonserie.h"
...
constexpr auto qt_meta_stringdata_CLASSLiaisonSerieENDCLASS = QtMocHelpers::stringData(
    "LiaisonSerie",
    "on_pushButtonOuvrirPortSerie_clicked",
    "",
    "on_pushButtonEnvoyer_clicked",
    "on_comboBox_currentTextChanged",
    "arg1",
    "onQSerialPortready_read"
);
...
Q_CONSTINIT const QMetaObject LiaisonSerie::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLiaisonSerieENDCLASS_t,
        ...
        // method 'on_pushButtonOuvrirPortSerie_clicked'
        ...
        // method 'onQSerialPortready_read'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void LiaisonSerie::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_pushButtonOuvrirPortSerie_clicked(); break;
        ...
        case 3: _t->onQSerialPortready_read(); break;
        default: ;
        }
    }
}
